...
const SingleCarouseItem = ({ data }) => {
  ...
  return (
    <div className='singleCarouselItem' style={{ backgroundImage: BackgroundImageUrl }} >

      {/* <img className='fill' src={`https://image.tmdb.org/t/p/original${data.backdrop_path}`} alt='poster' /> */}
      <div className='trending_align_css'>
        <div className='display1 trending_data_container' >
          ...
          <div className='right'>
            ...
            <div>
              ...
              {data.spoken_languages > 0 ? <p className='banner_spoken_language'><strong>L</strong> {data.spoken_languages[0].english_name}
              </p> : ""
              }
              {
